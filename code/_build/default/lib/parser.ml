...
let rec _menhir_goto_expr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Syntax.Exp.t) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState19 ->
        ...
        let _menhir_stack = Obj.magic _menhir_stack in
        let (((((_menhir_stack, _menhir_s), _), _, (i : (string))), _, (t : (Syntax.Typ.t))), _, (e : (Syntax.Exp.t))) = _menhir_stack in
        let _7 = () in
        let _6 = () in
        let _4 = () in
        let _2 = () in
...
# 3 "lib/parser.mly"
       (int)
# 107 "lib/parser.ml"
            ))), _, (e : (Syntax.Exp.t))) = _menhir_stack in
            let _6 = () in
            let _4 = () in
            let _2 = () in
            let _1 = () in
...
# 308 "lib/parser.ml"
    ...
    | MenhirState0 | MenhirState1 | MenhirState5 | MenhirState32 | MenhirState19 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        (match _tok with
...
and _menhir_goto_simple : _menhir_env -> 'ttv_tail -> _menhir_state -> (Syntax.Exp.t) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState0 | MenhirState1 | MenhirState5 | MenhirState32 | MenhirState24 | MenhirState19 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 395 "lib/parser.ml"
    ...
    | MenhirState27 | MenhirState25 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (e2 : (Syntax.Exp.t)) = _v in
        let (_menhir_stack, _menhir_s, (e1 : (Syntax.Exp.t))) = _menhir_stack in
        let _v : (Syntax.Exp.t) = 
# 38 "lib/parser.mly"
...
# 670 "lib/parser.ml"
    ...
    | MenhirState9 ->
        ...
        | _ ->
            ...
            let (_menhir_stack, _menhir_s, _) = _menhir_stack in
            _menhir_errorcase _menhir_env (Obj.magic _menhir_stack) _menhir_s)
    | MenhirState0 | MenhirState1 | MenhirState5 | MenhirState32 | MenhirState27 | MenhirState25 | MenhirState24 | MenhirState19 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
