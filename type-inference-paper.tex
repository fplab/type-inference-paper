...
%% Title information
\title{Type Hole Inference}         %% [Short Title] is optional;
...
\author{Zhiyi Pan}
 \authornote{Research advisor: Cyrus Omar; ACM student member number: 5024951; Category: undergraduate}          %% \authornote is optional;
                                        %% can be repeated if necessary
...
\email{zhiyipan@umich.edu}          %% \email is recommended
